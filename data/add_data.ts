...
const spaghetti = new_ingredient("carbohydrate", "spaghetti", ["gluten"], "50 g", 78, pair(1, 3));
const noodles = new_ingredient("carbohydrate", "noodles", [], "50 g", 69, pair(1, 3));
const white_rice = new_ingredient("carbohydrate", "white rice", [], "50 g", 65, pair(1, 3));
const brown_rice = new_ingredient("carbohydrate", "brown rice", [], "50 g", 55, pair(1, 3));
...
const pork_belly = new_ingredient("meat", "pork belly", ["meat"], "50 g", 177, pair(1, 2));
const sausage = new_ingredient("meat", "sausage", ["meat"], "", 210, pair(1, 1));
const minced_meat = new_ingredient("meat", "minced meat", ["meat"], "50 g", 120, pair(1, 3));
...
const shrimp = new_ingredient("meat", "shrimp", ["meat"], "50 g", 100, pair(1, 3));

const tarragon = new_ingredient("spice", "tarragon", [], "1 tsp", 10, pair(1, 2));
...
const rosemary = new_ingredient("spice", "rosemary", [], "1 tsp", 4, pair(1, 2));
const mint = new_ingredient("spice", "mint", [], "1 tsp", 4, pair(1, 2));
const ginger_powder = new_ingredient("spice", "ginger powder", [], "1 tsp", 6, pair(1, 2));
const thyme = new_ingredient("spice", "thyme", [], " tsp", 6, pair(1, 2));
const paprika_powder = new_ingredient("spice", "paprika powder", [], "1 tsp", 7, pair(1, 2));
const cardamom = new_ingredient("spice", "cardamom", [], "1 tsp", 7, pair(1, 2));
const coriander = new_ingredient("spice", "coriander", [], "1 tsp", 8, pair(1, 2));
const anise_powder = new_ingredient("spice", "anise powder", [], "1 tsp", 10, pair(1, 2));
const cinnamon = new_ingredient("spice", "cinnamon", [], "1 tsp", 6, pair(1, 2));
const cloves = new_ingredient("spice", "cloves", [], "1 tsp", 7, pair(1, 2));
const onion_powder = new_ingredient("spice", "onion powder", [], "1 tsp", 9, pair(1, 2));
const garlic_powder = new_ingredient("spice", "garlic powder", [], "1 tsp", 9, pair(1, 2));
const turmeric = new_ingredient("spice", "turmeric", [], "1 tsp", 9, pair(1, 2));
const chili_flakes = new_ingredient("spice", "chili flakes", [], "1 tsp", 15, pair(1, 2));
