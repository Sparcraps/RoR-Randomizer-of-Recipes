...
var main_menu_2 = require("./main_menu");
...
function configure() {
    ...
    function dietary_prompt() {
        ...
        function configure_dietary() {
            ...
            function select_valid_dietary() {
                var valid = main_menu_2.valid_dietary_restrictions;
    ...
    function configure_ingredients() {
        ...
        function select_allergies(ingredient, print_contents) {
            ...
            var allergy_array = [];
            var valid_dietary_not_active = __spreadArray([], main_menu_2.valid_dietary_restrictions, true);
            valid_dietary_not_active.push("");
            (0, menu_global_functions_1.print_bold)("Valid dietary restrictions: ");
            (0, menu_global_functions_1.print_alternatives)(main_menu_2.valid_dietary_restrictions);
        ...
        function select_measurement(ingredient, print_contents) {
            ...
            ingredient.measurement = (0, main_menu_1.prompt)('Enter unit of measurement either as amount in the format of a float number, or as a float followed by a string, e.g. "0.5dl": ').trim().toLowerCase();
            return ingredient;
        }
        ...
        function remove_ingredient_menu() {
            function search_and_delete() {
                var input = (0, main_menu_1.prompt)("Enter search string, or press enter to go back without removing an ingredient: ").trim().toLowerCase();
                if (input !== "") {
                    try {
