...
const aubergine = new_ingredient("vegetable", "aubergine", [], "0.5", 61, pair(1, 1));
const garlic_clove = new_ingredient("vegetable", "garlic clove", [], "", 4, pair(1, 3));
const tomato = new_ingredient("vegetable", "tomato", [], "", 22, pair(1, 2));
...
const chorizo = new_ingredient("meat", "chorizo", ["meat"], "", 200, pair(1, 1));
